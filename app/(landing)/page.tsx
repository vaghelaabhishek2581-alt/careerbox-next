...
const mentors = [
  {
    ...
    image: "/counsellor1.png",
    id: "mbpatel",
    rating: 4.9,
    reviews: 150,
    counsellingCount: 20000,
  },
  {
    name: "Mahesh Patel",
    role: "Sr. Mentor(Founder)",
    qualification: "MSc.Tech",
    experience: "6 Year Experience",
    image: "/counsellor2.png",
    id: "mkpatel",
    rating: 4.6,
    reviews: 130,
    counsellingCount: 4500,
  },
  {
    ...
    image: "/counsellor3.png",
    id: "abhishekvaghela",
    rating: 4.5,
    reviews: 140,
    counsellingCount: 1200,
  },
  {
    name: "Vatsal Zinzuwadiya",
    role: "Cousellor",
    qualification: "B.Tech CE",
    experience: "3 Year Experience",
    image: "/counsellor4.png",
    id: "vatsalzinzuvadiya",
    rating: 4.2,
    reviews: 90,
    counsellingCount: 480,
  },
];
...
export default function LandingPage() {
  ...
  const slides = [
    ...
    },
    {
      ...
      primaryCta: {
        href: "/institutes-service",
        label: "Partner with CareerBox",
      },
  ...
  useEffect(() => {
    ...
    if (
      ...
      const flyers = Array.from(
        section.querySelectorAll(".student-tile"),
      ) as HTMLElement[];
    ...
    <div className="min-h-screen">
      ...
      <div>
                      ...
                      <div className="space-y-4 sm:space-y-5 md:space-y-6 pt-6 sm:pt-8 md:pt-12 lg:pt-16 pb-8 sm:pb-12 md:pb-16">
                        ...
                        <div className="hero-content flex flex-wrap gap-3">
                          ...
                          <Link href={slide.secondaryCta.href}>
                            <Button
                              size="lg"
                              className="px-6 w-full sm:w-auto bg-gradient-to-r from-indigo-600 to-purple-600 text-white"
                            >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 text-center items-start justify-items-center">
              ...
              <div>
                ...
                <div className="mt-2 text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300">
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          <div className="text-center">
            ...
            <p className="mt-4 text-base sm:text-lg md:text-xl text-gray-600">
              Course programs that you are dreaming for bright career
            </p>
          </div>
          ...
          <div className="mt-10 sm:mt-12 flex flex-wrap items-center justify-center gap-4 sm:gap-6 lg:gap-8 mx-[70px]">
            {programCategories.map((item) => (
              <Link
                key={item.title}
                href={`/recommendation-collections/?q=${encodeURIComponent(item.title)}&type=courses`}
                className="block"
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1fr_360px] gap-8 sm:gap-10 items-center">
                <div>
                  ...
                  <p className="mt-3 text-gray-300 text-sm sm:text-base">
                    Talk directly with an expert via live video call for
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center">
            <div className="text-[11px] sm:text-xs font-semibold text-blue-600 uppercase tracking-wider">
              Say Hello to Personalized Guidance
            </div>
            <div className="text-[10px] sm:text-[11px] md:text-xs text-gray-500 uppercase mt-1">
              Goodbye to Faceless Calls
            </div>
            ...
            <div className="mt-1 text-xl sm:text-2xl md:text-3xl font-semibold">
              Expert Advisor for{" "}
              <span className="underline decoration-blue-600 decoration-4 underline-offset-6 md:underline-offset-8">
                Right Guidance
              </span>
            </div>
            <p className="mt-6 text-gray-600 max-w-3xl md:max-w-4xl mx-auto text-sm sm:text-base">
              Our team of 100+ Senior Mentors have been delivering personalized,
              data-backed career success since 2019. Get the strategic insight
              you need for your successful future.
            </p>
          </div>
                    ...
                    <div className="group relative mx-auto w-full max-w-[240px] sm:max-w-[260px] md:max-w-[280px]">
                      <div className="rounded-2xl bg-gradient-to-br from-purple-200 via-blue-200 to-indigo-200 h-[280px] sm:h-[300px]">
                        <img
                          src={`${m.image}`}
                          alt={`${m.name} portrait`}
                          className="absolute inset-0 w-full h-full object-cover rounded-2xl border-2 border-white/10"
                        />
                      ...
                      <div className="absolute left-1/2 -translate-x-1/2 -bottom-3 w-[80%] bg-black/60 text-white rounded-xl shadow-lg p-3 sm:p-4 text-center">
                        ...
                        <div className="mt-1 text-[11px] sm:text-xs text-white-500">
                          {m.role}{" "}
                          <span className="ml-1">{m.qualification}</span>
                        </div>
                        <div className="mt-1 text-[11px] sm:text-xs text-white-500">
                          {m.experience}
                        </div>
                        <div className="mt-2">
                          <Link href="/career-counselling">
                            <Button
                              size="sm"
                              className="rounded-full px-4 bg-white text-black hover:bg-gray-100"
                            >
                              Consult Now
                            </Button>
                          </Link>
        ...
        <section
          id="students-band"
          className="relative w-full bg-[#11867B] mt-16 sm:mt-20 py-14 sm:py-16 md:py-20 min-h-[420px] sm:min-h-[560px] md:min-h-[700px] overflow-hidden"
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              <div className="mx-auto inline-flex flex-col items-center bg-black/50 rounded-2xl px-5 sm:px-6 md:px-8 py-3 sm:py-4 md:py-5 shadow-sm">
                <div className="text-white text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight">
                  MILLIONS OF STUDENT
                </div>
                <div className="mt-1 sm:mt-2 text-white/90 text-base sm:text-lg md:text-xl">
                  needs better career counselling
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mx-[70px] py-16">
          ...
          <div className="text-center">
            ...
            <p className="mt-3 text-base md:text-lg text-gray-700">
              Partner with CareerBox and Reach Thousands of Future Students
            </p>
            ...
            <p className="mt-6 text-sm md:text-base text-gray-700">
              Are you an educational institution looking to connect with
              motivated students seeking personalized career guidance?
            </p>
            <p className="mt-1 text-sm md:text-base text-gray-700">
              Join the CareerBox network to showcase your programs and drive
              enrollment.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Get your institute's profile and programs in front of a highly targeted audience actively searching for their next career step.",
              },
              {
                title: "Targeted Enrollment",
                desc: "Connect directly with students whose career goals align perfectly with your course offerings.",
              },
              {
                title: "Seamless Integration",
                desc: "Easily manage your institute's profile, update course details, and track inquiries through our dedicated partner portal.",
              },
            ].map((card) => (
              <Card
                key={card.title}
                className="rounded-2xl bg-rose-50 shadow-sm"
              >
                <CardContent className="p-8">
                  <div className="text-lg md:text-xl font-semibold text-gray-900 mb-3 text-center">
                    {card.title}
                  </div>
            ...
            <Link href="/institutes-service" className="block">
              <div className="rounded-3xl bg-gradient-to-r from-blue-600 to-purple-600 text-white px-10 py-12 md:py-14 text-center shadow-lg">
                <div className="text-2xl md:text-3xl font-bold">
                  Join Our Institute Partner Program
                </div>
                <div className="mt-6 flex flex-col items-center gap-2">
                  <div className="text-base md:text-lg font-semibold">
                    Call Us:{" "}
                    <span className="font-normal">+91 99096 75185</span>
                  </div>
                  <div className="text-base md:text-lg font-semibold">
                    Email:{" "}
                    <span className="font-normal">partner@careerbox.in</span>
                  </div>
                </div>
              </div>
            </Link>
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 max-w-3xl md:max-w-4xl mx-auto text-sm sm:text-base text-gray-700">
              We are here to help you take the next step in your career journey.
              Whether you have questions about our services, need technical
              support, or want to book your personalized counseling session,
              reach out to us!
            </p>
          </div>
          ...
          <div className="mt-10 sm:mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center mx-[20px] sm:mx-[200px]">
            ...
            <div className="text-gray-900">
              ...
              <h3 className="mt-8 sm:mt-10 text-xl sm:text-2xl md:text-3xl font-semibold">
                Drop Us an Email
              </h3>
