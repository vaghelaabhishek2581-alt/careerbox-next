...
export default function AdminInstituteDetailPage() {
  ...
  async function onSave() {
    try {
      if (!form?.slug) {
        toast({
          title: "Missing slug",
          description: "Institute slug is required",
          variant: "destructive",
        });
        return;
      }
      setSaving(true);
      const res = await fetch(
        `/api/admin/institutes/${encodeURIComponent(form.slug)}`,
        {
          method: "PATCH",
  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <Input
              value={form?.id || ""}
              onChange={(e) => setPath(["id"], e.target.value)}
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => setPath(["shortName"], e.target.value)}
            />
          </div>
          <div>
            <Label>Slug</Label>
            <Input
              value={form?.slug || ""}
              onChange={(e) => setPath(["slug"], e.target.value)}
            />
          </div>
          <div>
          ...
          <div>
            ...
            <Input
              value={form?.type || ""}
              onChange={(e) => setPath(["type"], e.target.value)}
            />
          </div>
          <div>
            <Label>Status</Label>
            <Input
              value={form?.status || ""}
              onChange={(e) => setPath(["status"], e.target.value)}
            />
          </div>
          <div className="md:col-span-2">
          ...
          <div className="md:col-span-3">
            ...
            <Input
              value={form?.website || ""}
              onChange={(e) => setPath(["website"], e.target.value)}
            />
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              ...
              <Input
                value={getPath(["accreditation", "naac", "grade"], "")}
                onChange={(e) =>
                  setPath(["accreditation", "naac", "grade"], e.target.value)
                }
              />
            </div>
            <div>
              <Label>NAAC Category</Label>
              <Input
                value={getPath(["accreditation", "naac", "category"], "")}
                onChange={(e) =>
                  setPath(["accreditation", "naac", "category"], e.target.value)
                }
              />
            </div>
            <div>
            ...
            <div className="md:col-span-2">
              <Label>NAAC Valid Until</Label>
              <Input
                value={getPath(["accreditation", "naac", "validUntil"], "")}
                onChange={(e) =>
                  setPath(
            ...
            <div className="md:col-span-4">
              <Label>UGC Recognition</Label>
              <Input
                value={getPath(["accreditation", "ugc", "recognition"], "")}
                onChange={(e) =>
                  setPath(
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                size="sm"
                onClick={() =>
                  setPath(["accreditation", "nirf"], {
                    ...(getPath(["accreditation", "nirf"], {}) as any),
                    "": "",
                  })
                }
              >
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setPath(["accreditation", "nirf"], obj);
                        }}
                        placeholder="Pharmacy, Innovation, University..."
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          obj[originalKey] = e.target.value;
                          setPath(["accreditation", "nirf"], obj);
                        }}
                        placeholder="41, 11-50..."
                      />
                    </div>
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="md:col-span-3">
            <Label>Address</Label>
            <Input
              value={getPath(["location", "address"], "")}
              onChange={(e) => setPath(["location", "address"], e.target.value)}
            />
          </div>
          <div>
            <Label>City</Label>
            <Input
              value={getPath(["location", "city"], "")}
              onChange={(e) => setPath(["location", "city"], e.target.value)}
            />
          </div>
          <div>
            <Label>State</Label>
            <Input
              value={getPath(["location", "state"], "")}
              onChange={(e) => setPath(["location", "state"], e.target.value)}
            />
          </div>
          <div>
            <Label>Pincode</Label>
            <Input
              value={getPath(["location", "pincode"], "")}
              onChange={(e) => setPath(["location", "pincode"], e.target.value)}
            />
          </div>
          <div>
            <Label>Country</Label>
            <Input
              value={getPath(["location", "country"], "")}
              onChange={(e) => setPath(["location", "country"], e.target.value)}
            />
          </div>
          <div>
          ...
          <div className="md:col-span-3">
            <StringList
              ...
              values={getPath(["location", "nearbyLandmarks"], [])}
              onChange={(v) => setPath(["location", "nearbyLandmarks"], v)}
          ...
          <div className="md:col-span-3">
            <StringList
              label="Phones"
              values={getPath(["contact", "phone"], [])}
              onChange={(v) => setPath(["contact", "phone"], v)}
              placeholder="Phone"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <Input
              value={getPath(["contact", "website"], "")}
              onChange={(e) => setPath(["contact", "website"], e.target.value)}
            />
          </div>
          <div>
            <Label>Admissions Email</Label>
            <Input
              value={getPath(["contact", "admissionsEmail"], "")}
              onChange={(e) =>
                setPath(["contact", "admissionsEmail"], e.target.value)
              }
            />
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Overview (Key-Value Pairs)</CardTitle>
        </CardHeader>
                ...
                >
                  <div className="md:col-span-2">
                    ...
                    <Input
                      value={item.key || ""}
                      onChange={(e) => {
                        const arr = [...(getPath(["overview"], []) as any[])];
                        arr[idx] = { ...arr[idx], key: e.target.value };
                        setPath(["overview"], arr);
                      }}
                      placeholder="Establishment year, Campus size..."
                    />
                  </div>
                  <div className="md:col-span-2">
                    <Label>Value</Label>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                value={getPath(["campusDetails", "campusType"], "")}
                onChange={(e) =>
                  setPath(["campusDetails", "campusType"], e.target.value)
                }
              />
            </div>
            <div>
              ...
              <Input
                value={getPath(["campusDetails", "environment"], "")}
                onChange={(e) =>
                  setPath(["campusDetails", "environment"], e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-3">
              {(getPath(["campusDetails", "facilities"], []) as any[]).map(
                    ...
                    <div className="md:col-span-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          arr[idx] = { ...arr[idx], key: e.target.value };
                          setPath(["campusDetails", "facilities"], arr);
                        }}
                        placeholder="Library, Gym, Hostel..."
                      />
                    </div>
                    <div className="md:col-span-2">
          ...
          <div>
            <StringList
              label="Facilities Array (Simple List)"
              values={getPath(["campusDetails", "facilities_arr"], [])}
              onChange={(v) => setPath(["campusDetails", "facilities_arr"], v)}
              placeholder="Library, Gym, Hostel..."
            />
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
              ...
              <Input
                value={getPath(["academics", "studentFacultyRatio"], "")}
                onChange={(e) =>
                  setPath(["academics", "studentFacultyRatio"], e.target.value)
                }
                placeholder="15:1"
              />
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-3">
              {(getPath(["academics", "schools"], []) as any[]).map(
                (s: any, idx: number) => (
                  <div
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-3">
              {(getPath(["academics", "programOverviews"], []) as any[]).map(
                (item: any, idx: number) => (
                  <div
                    className="grid grid-cols-1 md:grid-cols-5 gap-2"
                    key={idx}
                    ...
                    <div className="md:col-span-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          arr[idx] = { ...arr[idx], key: e.target.value };
                          setPath(["academics", "programOverviews"], arr);
                        }}
                        placeholder="UG Programs, PG Programs..."
                      />
                    </div>
                    <div className="md:col-span-2">
                      <Label>Value</Label>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Faculty & Student Data</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
            ...
            <div className="space-y-3">
              {(
                getPath(["faculty_student_ratio", "faculties"], []) as any[]
                  ...
                  <div className="md:col-span-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        arr[idx] = { ...arr[idx], key: e.target.value };
                        setPath(["faculty_student_ratio", "faculties"], arr);
                      }}
                      placeholder="Total Faculties, PhD holders..."
                    />
                  </div>
                  <div className="md:col-span-2">
                    <Label>Value</Label>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-4">
              {(
                getPath(["faculty_student_ratio", "students"], []) as any[]
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setPath(["faculty_student_ratio", "students"], arr);
                        }}
                        placeholder="UG - 4 years student admission"
                      />
                    </div>
                    <div className="flex items-end">
                      <Button
      ...
      <Card>
        <CardHeader>
          <CardTitle>Admissions & Placements</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <div>
            <Label>Application Fee</Label>
            <Input
              value={getPath(["admissions", "applicationFee"], "")}
              onChange={(e) =>
                setPath(["admissions", "applicationFee"], e.target.value)
              }
              placeholder="1000 INR or any format"
            />
          </div>
          <StringList
            label="Admission Process Steps"
            values={getPath(["admissions", "admissionProcess"], [])}
            onChange={(v) => setPath(["admissions", "admissionProcess"], v)}
            placeholder="Step"
          />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        delete obj[k];
                        obj[e.target.value] = val;
                        setPath(["admissions", "reservationPolicy"], obj);
                      }}
          ...
          <StringList
            ...
            values={getPath(["placements", "topRecruiters"], [])}
            onChange={(v) => setPath(["placements", "topRecruiters"], v)}
            placeholder="Company"
          />
          <StringList
            label="Sectors"
            values={getPath(["placements", "sectors"], [])}
            onChange={(v) => setPath(["placements", "sectors"], v)}
            placeholder="IT & Software - 40%"
          />
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div>
            <Label>Rankings Title</Label>
            <Input
              value={getPath(["rankings", "title"], "")}
              onChange={(e) => setPath(["rankings", "title"], e.target.value)}
            />
          </div>
          <div>
            <Label>Rankings Description</Label>
            <Input
              value={getPath(["rankings", "description"], "")}
              onChange={(e) =>
                setPath(["rankings", "description"], e.target.value)
              }
            />
          </div>
          <div>
            <Label>Rankings Detail Description</Label>
            <Input
              value={getPath(["rankings", "rankingsDescription"], "")}
              onChange={(e) =>
                setPath(["rankings", "rankingsDescription"], e.target.value)
              }
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-3">
              {(getPath(["rankings", "national", "national"], []) as any[])
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-4">
              {(getPath(["rankings", "data"], []) as any[]).map(
                (publisher: any, pubIdx: number) => (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                      <div>
                        ...
                        <Input
                          ...
                          placeholder="NIRF, Outlook..."
                        />
                      </div>
                      <div>
                        <Label>Publisher Logo URL</Label>
                        <Input
                          value={publisher.publisherLogo || ""}
                          onChange={(e) => {
                            const arr = [
                              ...(getPath(["rankings", "data"], []) as any[]),
                            ];
      ...
      <Card>
        <CardHeader>
          <CardTitle>Research & Alumni</CardTitle>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <Input
              value={getPath(["researchAndInnovation", "researchFunding"], "")}
              onChange={(e) =>
                setPath(
          ...
          <div className="md:col-span-4">
            <StringList
              ...
              values={getPath(["researchAndInnovation", "collaborations"], [])}
              onChange={(v) =>
                setPath(["researchAndInnovation", "collaborations"], v)
              }
              placeholder="Partner"
            />
          </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Awards & Media</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <StringList
            label="Awards (titles)"
            values={getPath(["awards"], [])}
            onChange={(v) => setPath(["awards"], v)}
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                size="sm"
                onClick={() =>
                  setPath(["mediaGallery", "photos"], {
                    ...(getPath(["mediaGallery", "photos"], {}) as any),
                    "": [],
                  })
                }
              >
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        delete obj[category];
                        obj[e.target.value] = val;
                        setPath(["mediaGallery", "photos"], obj);
                      }}
                    />
                  </div>
                  <div className="md:col-span-2">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-3">
              {(getPath(["mediaGallery", "videos"], []) as any[]).map(
                (v: any, idx: number) => (
                  <div
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          setPath(["mediaGallery", "videos"], arr);
                        }}
                      />
                    </div>
                    <div>
                ...
                <div className="space-y-4 border rounded-md p-4" key={progIdx}>
                  ...
                  <div className="space-y-2">
                    <StringList
                      ...
                      values={prog.eligibilityExams || []}
                      onChange={(v) => {
                        const arr = [...(getPath(["programmes"], []) as any[])];
                        arr[progIdx] = { ...arr[progIdx], eligibilityExams: v };
                        setPath(["programmes"], arr);
                      }}
                      placeholder="GMAT, CAT, XAT"
                    />
                  </div>
                    ...
                    <div className="space-y-4">
                      {(prog.course || []).map(
                        (course: any, courseIdx: number) => (
                          <div
                            className="space-y-3 border rounded-md p-4 bg-gray-50"
                            key={courseIdx}
                          >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                              ...
                              <div>
                                ...
                                <Input
                                  value={course.location?.locality || ""}
                                  onChange={(e) => {
                                    const arr = [
                                      ...(getPath(["programmes"], []) as any[]),
                                    ];
                                    ...
                                    location.locality = e.target.value;
                                    courses[courseIdx] = {
                                      ...courses[courseIdx],
                                      location,
                                    };
                            ...
                            <div className="md:col-span-4">
                              <StringList
                                ...
                                placeholder="INC, AICTE"
                              />
                            </div>
                            <div className="md:col-span-4">
                              <StringList
                                label="Eligibility Exams"
                                values={course.eligibilityExams || []}
                                onChange={(v) => {
                                  const arr = [
                                    ...(getPath(["programmes"], []) as any[]),
                                  ];
                                ...
                                placeholder="GMAT, CAT"
                              />
                            </div>
                            <div className="md:col-span-4">
                              <StringList
                                label="Top Recruiters"
                                values={course.placements?.topRecruiters || []}
                                onChange={(v) => {
                                  const arr = [
                                    ...(getPath(["programmes"], []) as any[]),
                                  ];
