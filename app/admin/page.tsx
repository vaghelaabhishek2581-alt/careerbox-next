...
export default function AdminDashboard() {
  ...
  const { registrationIntents, loading } = useSelector(
    (state: RootState) => state.admin
  );
  const { stats, selectedDateRange } = useSelector(
            ...
            <CardContent>
              <div className="space-y-4">
                {registrationIntents?.slice(0, 5).map((intent) => {
                  const TypeIcon =
                    intent.type === "institute" ? Building2 : Briefcase;
                  const statusConfig = {
                    pending: {
                  ...
                  const StatusIcon =
                    statusConfig[intent.status as keyof typeof statusConfig]
                      ?.icon || Clock;
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <Badge
                          className={
                            statusConfig[
                              intent.status as keyof typeof statusConfig
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {[
                  ...
                  {
                    action: "Business application reviewed",
                    time: "15 mins ago",
                    type: "info",
                  },
                  {
