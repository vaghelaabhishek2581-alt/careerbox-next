...
async function terminateAllUserSessionsHandler(
  ...
  try {
    ...
    return createSuccessResponse(null, `All sessions terminated for ${targetUser.email}`)
...
export const DELETE = withJWTAuthDynamic(terminateAllUserSessionsHandler, { requireAdmin: true })
export const GET = withJWTAuthDynamic(getUserSessionsHandler, { requireAdmin: true })
