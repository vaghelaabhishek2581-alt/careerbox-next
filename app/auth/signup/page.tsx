  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-purple-600 to-blue-700">
        ...
        >
          <source src="/login and signup.mp4" type="video/mp4" />
        </video>
      ...
      {/* Auth Form */}
      <div className="flex-1 flex items-center justify-center p-6 bg-gradient-to-br from-slate-50 to-purple-50 lg:bg-white">
        <div className="w-full max-w-md">
          {/* Back to home - Mobile Only */}
          <Link href="/" className="lg:hidden inline-flex items-center text-gray-600 hover:text-gray-900 mb-8 transition-colors">
                ...
                <p className="text-gray-600">
                  ...
                  <button
                    ...
                    className={`font-semibold hover:underline ${
                      mode === 'signup' ? 'text-purple-600 hover:text-purple-700' : 'text-blue-600 hover:text-blue-700'
                    }`}
                    disabled={isLoading}
                  >
