        ...
        <Card className="text-center">
          <CardContent className="p-12">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Your {registrationType} registration application has been
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-8">
              ...
              <div className="space-y-3 text-sm text-gray-600">
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span>
                    You&apos;ll receive email updates about your application
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3 text-sm text-gray-700">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      If approved, you&apos;ll either get free access or be
                      asked to complete payment
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-800">
                <strong>Important:</strong> Keep an eye on your email for
                updates. You can also track your application status anytime from
                your dashboard.
              </p>
            </div>
          </CardContent>
