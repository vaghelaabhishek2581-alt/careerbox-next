...
//                     </span>
//                   </SelectItem>
//                   <SelectItem value="require_payment">
...
//                   <SelectTrigger
//                     className={
//                       !subscriptionPlan && error ? "border-red-500" : ""
//                     }
//                   >
//                     <SelectValue placeholder="Select plan (required)" />
//                   </SelectTrigger>
//                   <SelectContent>
...
//                   <strong>Free Plan:</strong> Dashboard access with masked
//                   student lead contact info.
//                   <br />
//                   <strong>Premium Plan:</strong> Full access with unmasked leads
//                   and all features.
//                 </p>
//               </div>
//             )}
...
//                 </Select>
//                 <p className="text-xs text-gray-500 mt-1">
//                   User will be prompted to pay for the selected plan to activate
//                   their account.
//                 </p>
//               </div>
//             )}
