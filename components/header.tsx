...
import { Menu, Phone, Mail, Home, Users, Briefcase, Building2, GraduationCap, MessageCircle } from 'lucide-react';
...
const navigation = [
  ...
  { name: 'Free Counselling', href: '/career-counselling', icon: MessageCircle },
                      ...
                      return (
                        <Link
                          ...
                          className={cn(
                            ...
                            isActive ? 'primary' : 'text-gray-700'
                          )}
                        >
