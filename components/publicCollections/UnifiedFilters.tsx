...
export function UnifiedFilters({
  ...
  const activeAccreditations =
    currentAccreditation?.split(",").filter(Boolean) || [];
  ...
  return (
    <div className="space-y-6 relative">
            ...
            <div className="flex flex-wrap gap-2">
              {activeLocations.map((loc) => (
                ...
                >
                  ...
                  {availableFilters.locations.find((l) => l.value === loc)
                    ?.label || loc}
                  <button
                    onClick={() => updateFilter("city", loc, false)}
                    disabled={isPending}
              ...
              {activeTypes.map((typ) => (
                ...
                >
                  ...
                  {availableFilters.types.find((t) => t.value === typ)?.label ||
                    typ}
                  <button
              ...
              {activeCategories.map((cat) => (
                ...
                >
                  ...
                  {availableFilters.categories.find((c) => c.value === cat)
                    ?.label || cat}
                  <button
                    onClick={() => updateFilter("programme", cat, false)}
                    disabled={isPending}
                    className="ml-1 hover:bg-gray-300 rounded-full p-0.5"
                  >
                    <X className="h-3 w-3" />
              ...
              {activeAccreditations.map((acc) => (
                ...
                >
                  ...
                  {availableFilters.accreditations.find((a) => a.value === acc)
                    ?.label || acc}
                  <button
              ...
              {activeDegrees.map((deg) => (
                ...
                >
                  ...
                  {availableFilters.degrees.find((d) => d.value === deg)
                    ?.label || deg}
                  <button
                    onClick={() => updateFilter("course", deg, false)}
                    disabled={isPending}
                    className="ml-1 hover:bg-gray-300 rounded-full p-0.5"
                  >
                    <X className="h-3 w-3" />
      ...
      {(currentType === "courses" || currentType === "programs") &&
        availableFilters.degrees.length > 0 && (
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base">
                ...
                >
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      checked={activeAccreditations.includes(
                        accreditation.value,
                      )}
                      disabled={isPending}
                      onCheckedChange={(checked) =>
