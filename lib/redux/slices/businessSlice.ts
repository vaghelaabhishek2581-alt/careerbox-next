...
export const updateBusiness = createAsyncThunk(
  ...
  async (
    { businessId, businessData }: { businessId: string; businessData: any },
    { rejectWithValue }
  ) => {
    try {
      const response = await API.businesses.updateBusiness(
        businessId,
        businessData
      );
...
export const fetchBusinessProfile = createAsyncThunk(
  ...
  async (businessId: string, { rejectWithValue }) => {
    try {
      ...
      if (!response.success) {
        return rejectWithValue(
          response.error || "Failed to fetch business profile"
        );
      }
...
export const updateBusinessProfile = createAsyncThunk(
  ...
  async (
    { businessId, profileData }: { businessId: string; profileData: any },
    { rejectWithValue }
  ) => {
    try {
      const response = await API.businesses.updateBusiness(
      ...
      if (!response.success) {
        return rejectWithValue(
          response.error || "Failed to update business profile"
        );
      }
