...
import { registerAllEvents } from './events/index.mjs'
 ...
 */
export function initializeSocketServer(httpServer: HttpServer, dev: boolean): Server {
  ...
  io.use(async (socket, next) => {
    try {
      ...
      try {
        ...
        console.log('✅ Socket authenticated for user:', decoded.userId || decoded.sub)
        ...
        console.log('❌ Invalid JWT token for socket:', socket.id, errorMessage)
