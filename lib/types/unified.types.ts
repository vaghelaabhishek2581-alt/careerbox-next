...
export const PersonalDetailsSchema = z.object({
  ...
  publicProfileId: z.string().min(3, 'Profile ID must be at least 3 characters').max(30).regex(/^[a-zA-Z0-9_-]+$/, 'Profile ID can only contain letters, numbers, hyphens, and underscores'),
...
export const InstituteProfileSchema = z.object({
  ...
  type: z.enum(['university', 'college', 'technical_institute', 'vocational_school', 'online_university', 'research_institute', 'training_center', 'academy', 'school']),
  description: z.string().min(50, 'Description must be at least 50 characters'),
  website: z.string().url().optional(),
  logo: z.string().url().optional(),
  coverImage: z.string().url().optional(),
...
export const SearchFiltersSchema = z.object({
  ...
  sortBy: z.enum(['relevance', 'date', 'rating', 'salary', 'distance']).default('relevance'),
...
export const SKILL_CATEGORIES = {
  Programming: [
    ...
    'React', 'Angular', 'Vue.js', 'Node.js', 'Express.js', 'Next.js', 'Laravel', 'Django', 'Spring Boot'
  ],
  Design: [
    'UI/UX Design', 'Graphic Design', 'Web Design', 'Mobile Design', 'Product Design',
    'Figma', 'Adobe Creative Suite', 'Sketch', 'InVision', 'Canva', 'Photoshop', 'Illustrator'
  ],
  Marketing: [
    'Digital Marketing', 'SEO', 'SEM', 'Content Marketing', 'Social Media Marketing',
    'Email Marketing', 'Influencer Marketing', 'Brand Management', 'Market Research'
  ],
  Business: [
    'Project Management', 'Business Analysis', 'Strategy Planning', 'Leadership',
    'Team Management', 'Sales', 'Finance', 'Operations', 'Product Management', 'Business Development'
  ],
  'Data & Analytics': [
    'Data Analysis', 'Machine Learning', 'Artificial Intelligence', 'Data Science',
    'Big Data', 'SQL', 'NoSQL', 'Excel', 'Tableau', 'Power BI', 'Google Analytics', 'Statistical Analysis'
  ],
  'Cloud & DevOps': [
...
export const DEGREE_TYPES = [
  ...
  'MBA', 'PhD', 'Certificate', 'Diploma', 'Professional Certification'
] as const

export const USER_ROLES = [
  'student', 'professional', 'freelancer', 'entrepreneur', 'business_owner',
  'recruiter', 'mentor', 'investor', 'job_seeker'
] as const
