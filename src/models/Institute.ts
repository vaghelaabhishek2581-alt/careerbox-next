...
// Institute Schema
const InstituteSchema = new Schema<any>(
  {
    userId: {
    ...
    publicProfileId: {
      ...
      match: [
        /^[a-z0-9-_]+$/,
        "Public profile ID can only contain lowercase letters, numbers, hyphens, and underscores",
      ],
    },
    email: {
      type: String,
...
// InstituteSchema.virtual("id").get(function (): any {
